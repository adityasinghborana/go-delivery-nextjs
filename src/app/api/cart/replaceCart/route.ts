// replace cart is need when cart is already exist of service a now you want to add the service so this delete the old cart
...
export async function POST(request: NextRequest) {
  try {
    ...
    const addtocart = await cartusecase.replaceCartUsecase(data, userId);
